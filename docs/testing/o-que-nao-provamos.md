...
| O produtor de Chimera Ant ainda não existe | identidade, molde, orçamento de rastreamento, colônia, materializador pendente e Nen tático têm cobertura de domínio. O caminho de materialização server-side existe, mas nenhuma colônia é fundada por gameplay; save/restart real e intenção de Nen continuam sem prova | EN8/EN9 com entidade |
